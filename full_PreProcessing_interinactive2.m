...
subj = importTextList('/Users/cinnamon/Box/bch/Provide/bean6subs-missing.txt');  
pathnames = importTextList('/Users/cinnamon/Box/bch/Provide/bean6paths-missing.txt');
...
dep1 = ['/Volumes/DMC-Gaab2/data/Bangladesh/5yrProvide/' subj{sub}]; % destination
