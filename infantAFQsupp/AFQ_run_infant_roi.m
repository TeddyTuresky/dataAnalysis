function [afq patient_data control_data norms abn abnTracts] = AFQ_run_infant_roi(sub_dirs, sub_group, afq)
...
for ii = runsubs
    ...
    if AFQ_get(afq, 'do segmentation',ii) == 1
        ...
        % Segment fiber group
        fg_classified = AFQ_SegmentFiberGroups_infant_roi(dtFile, fg, [], [],[], antsInvWarp);
