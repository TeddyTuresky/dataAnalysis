function [fg_classified,fg_unclassified,classification,fg] = ...
    AFQ_SegmentFiberGroups_infant(dt6File, fg, Atlas, ...
...
affineInf2MNI = '/Users/cinnamon/Documents/transformInf2MNI/unc2mni0GenericAffine.mat';
invAffineInf2MNI = ['[' affineInf2MNI ',1]' ];
warpInf2MNI = '/Users/cinnamon/Documents/transformInf2MNI/unc2mni1Warp.nii.gz';
invWarpInf2MNI = '/Users/cinnamon/Documents/transformInf2MNI/unc2mni1InverseWarp.nii.gz';

[pinv,~] = fileparts(antsInvWarp);
affineXform = [pinv '/t1_acpc0GenericAffine.mat'];
invAffineXform = ['[' pinv '/t1_acpc0GenericAffine.mat,1]'];
fibin = [pinv '/fibin.csv'];
fibout = [pinv '/fibout.csv'];

% bzero = readFileNifti(dt.files.b0);
% t1 = readFileNifti('/Users/cinnamon/Documents/dti2114/dtitrilin/bin/t1_acpc.nii.gz'); % 
template = '/Users/cinnamon/Documents/transformInf2MNI/rinfant-neo-withSkull.nii';
refNifti = template;
% temp = readFileNifti(template);
% qoff(1,1) = bzero.qoffset_x - temp.qoffset_x;
% qoff(2,1) = bzero.qoffset_y - temp.qoffset_y;
% qoff(3,1) = bzero.qoffset_z - temp.qoffset_z;
...
fg_sn = ANTS_applyTransform2Points(fg, invWarpInf2MNI, invAffineInf2MNI, antsInvWarp, invAffineXform, fibin, fibout); 
% fg_sn = ANTS_applyTransform2Points(fg, invWarpInf2MNI, invAffineInf2MNI, antsInvWarp, invAffineXform, fibin, fibout,qoff ); 

save([pinv '/xformFibs.mat'],'fg_sn');
...
fgCoords2 = {};
for ll = 1:size(fg_sn.fibers,1); 
    fgCoords2{ll,1} = mrAnatXformCoords(moriTracts.qto_ijk, fg_sn.fibers{ll,1})'; 
end

save([pinv '/xformFibsAtlas.mat'],'fgCoords');
save([pinv '/xformFibsAtlas2.mat'],'fgCoords2');
