...
fg = dtiReadFibers('fibers/MoriGroups_clean_D5_L4.mat'); % CC_Occipital_clean_D5_L4.mat'); % 
gg = dtiReadFibers('fibers/CC_Occipital_clean_D5_L4.mat'); % TKT installed this hack because RenderFibers only works for traditional fg structure apparently
...
tst=zeros(1,100);
tst(1,:)=5;
tst(1,48:85)=2; %change here to choose nodes; include multiple tst rows
% if have multiple segments of significant nodes you wish to display
%tst(1,23:25)=2;

mymap = [51/255 126/255 255/255; 1 1 1];
TractProfile(3)=AFQ_TractProfileSet(TractProfile(3),'vals','Tstat',tst);... % TractProfile(15); I should change these back to match line 16 if I need CC
    AFQ_RenderFibers(fg(3),'color',... %  fg(15)
    [51/255 126/255 255/255],'tractprofile',TractProfile(3), ... % TractProfile(15) red: [1 .2 .2]
