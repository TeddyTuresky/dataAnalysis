...
mymap = [153/255 51/255 255/255; 1 1 1]; % first row is band, second row is tube [51/255 126/255 255/255; 1 1 1]
TractProfile(15)=AFQ_TractProfileSet(TractProfile(15),'vals','Tstat',tst);... % TractProfile(15); I should change these back to match line 18 if I need CC
    ...
    [153/255 51/255 255/255],'tractprofile',TractProfile(15), ... % TractProfile(15) red: [1 .2 .2]
    'val','Tstat','radius',[0.5 3],'numfibers',500,'cmap',mymap,'crange',[0.5 5]); % 'cmap', 'hot', 'radius',[1 3]
