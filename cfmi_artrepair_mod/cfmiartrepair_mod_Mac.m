...
perc=1.5; %%%% perc = cut-off of global signal percent
mvmt=0.75;%%% mvmt = cut-off of movement in mm
...
ThrowOutSubjectThresh = input('What is your cut-off for percent of bad scans before subject is thrown out? ');

clear RegressorType

global RegressorType;
RegressorType =input('Do you want regressors based on Global Signal (1), Movement (2), or Both (3): ');
...
fnames=dir(fullfile(currfolder,'swar*.nii'));
...
WIP_art_global_regressors(fpaths,rppath,perc,mvmt,writeout);
